...
fun Application.legacyRoutes() {
    ...
    val movedResources = mapOf(
        "/animals/females/{${PATH_VARIABLE}}" to "/animals/%s",
        "/animals/for-sale/{${PATH_VARIABLE}}" to "/animals/%s",
        "/animals/geldings/{${PATH_VARIABLE}}" to "/animals/%s",
        "/animals/sold/{${PATH_VARIABLE}}" to "/animals/%s",
